...
const Nav2 = ({ selector }) => {
    ...
    return (
        ...
        <div className={p.nav2Container}  >
            ...
            <button class="btn btn-primary" value={"prod"} onClick={(e) => selector(e.target.value)}>Productos</button>
            <button class="btn btn-primary" value={"orderUser2"} onClick={(e) => selector(e.target.value)}>Ordenes</button>
