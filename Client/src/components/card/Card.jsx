                ...
                <div className={c.buttoContainer}>
                    ...
                    {fav
                        ? (<button className={c.classCart1} onClick={handleFav}>❤️
                            {/* <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-hearts-off" width="44" height="13" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" strokeLinejoin="round">
                        ...
                        : (<button className={c.classCart2} onClick={handleFav}>🤍
                            {/* <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-heart" width="20" height="13" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" strokeLinejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
